...
export function RiskSurfaceMap() {
  ...
  return <div className="live-map risk-surface-map">
    ...
    {remote.data ? <GridSurfaceMap cells={cells} color={color} label={label} ariaLabel="Modeled ignition risk surface"/> : <div className="map-stage"><div className="map-status"><LoadState loading={remote.loading} error={remote.error} retry={remote.error?remote.retry:undefined}/></div></div>}
