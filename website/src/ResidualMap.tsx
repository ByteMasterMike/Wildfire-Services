...
export function ResidualMap() {
  ...
  return <div className="live-map residual-map">
    ...
    {remote.data ? <GridSurfaceMap cells={cells} color={color} label={label} ariaLabel="Model residual map"/> : <div className="map-stage"><div className="map-status"><LoadState loading={remote.loading} error={remote.error} retry={remote.error ? remote.retry : undefined}/></div></div>}
